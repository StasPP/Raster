...
begin
  ...
  if (Form1.ClickMode = 2) and (Form1.ClickMode = 2) then
    if Acont.Checked then
      if Form1.StringGrid1.RowCount >3 then
         Form1.CountControl.Click;
...
begin
  ...
  Begin
    if N=0 then
      Label7.Caption := 'New GeoPoint'
      else
        Label7.Caption := 'GeoPoint '+IntToStr(N);
  End
   else
    Begin
     if N=0 then
      Label7.Caption := 'New FramePoint'
      else
        Label7.Caption := 'FramePoint '+IntToStr(N);
