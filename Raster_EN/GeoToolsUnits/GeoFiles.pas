...
uses SysUtils;
//const // SuccessMsg =  'Датумы, эллипсоиды и системы координат успешно загружены';
      // ErrMsg =  'Ошибка загрузки. Необходим перезапуск';
